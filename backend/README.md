...
## Project Structure
    ...
    ├── restless_waterfall_29837  # Django project configurations
...
1. Clone this repo and `cd restless_waterfall_29837`
...
2. Clone this repo and `cd restless_waterfall_29837`
